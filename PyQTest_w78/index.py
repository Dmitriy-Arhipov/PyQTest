...
class Index(UI_main, QMainWindow):
    ...
    def f_info(self):
        ...
        self.mb.setText(
            '''PyQTest - программа для создания тестов, викторин, квизов, интеллектуальных игр и т.д. Конструктор тестов позволяет создать викторину или квиз в тестовом формате, конструктор игр - игру в формате "Jeopardy"/"Своя игра". 
Результаты работы можно конвертировать в XLSX (таблицы Excel) или CSV. Вы также можете превратить файл CSV или XLSX в заданном формате в игру или тест PyQTest
API теста: "ASK;CORRECT;MULTIMEDIA;ANSWERS", 
API игры: "X;Y;THEME;POINT;ASK;CORRECT;MULTIMEDIA". 
Эта строка - заголовок, ниже значения, разделенные знаком ";". Строки с ответами (CORRECT и ANSWERS) заносятся в двойные кавычки, разделитель - ";"''')
        self.mb.show()
